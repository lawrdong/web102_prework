...
const displayUnfundedStr = 
    ...
    Currently ${numOfUnfunded} ${numOfUnfunded == 1 ? "game remain" : "games remain"} unfunded. 
    We need your help to fund these amazing games!`

// create a new DOM element containing the template string and append it to the description container
const newInformation = document.createElement('p');
newInformation.textContent = displayUnfundedStr;
descriptionContainer.appendChild(newInformation);
